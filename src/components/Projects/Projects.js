...
function Projects(props) {
    return (
        <div className="projects">
            ...
            <Project imgPath={glonass} heading={"Создание видео \"Запуск ГЛОНАССа\""} id={7} description={<span>Я под руководством Синкевич Светланы смоделировал<br/>  запуск и вывод на орбиту спутника ГЛОНАСС средствами blender. Также<br/>  мной была создана игра где можно самому попробовать сориентировать спутник. </span>}/>
